...
{/* heading section */}
            <div> <h1 className="text-[29px] mb-2 font-bold text-gray-700">Welcome Back</h1> </div>
            ...
            <div className="bg-white shadow-md  w-[90%] sm:w-[90%]  md:w-[60%]  flex rounded-[40px]  p-3" >
                ...
                <div className="  rounded-[40px] relative flex-[55%] flex gap-5   flex-col  items-center  p-5 ounded-[40px]">
                    ...
                    <div className="flex  w-full  flex-col p-3 gap-4">
                        ...
                        <input  value={loginDetails.email} onChange={(e)=> setLoaginDetails({...loginDetails , email : e.target.value})} className=" w-full px-3 py-3  bg-gray-50 outline-none focus:bg-white  rounded-md border shadow-md   border-gray-300 " type="email" placeholder="enter email" />
                        </div>

                        <div className="relative flex flex-col w-full justify-center items-center">
                        <input  value={loginDetails.password} onChange={(e)=> handlePasswordChange(e) } className=" w-full px-3 py-3  bg-gray-50 outline-none focus:bg-white  rounded-md border shadow-md   border-gray-300 " type="password" placeholder="enter password" />
                    ...
                    <Button  _hover={{bg:"yellow.500"}} cursor={` ${validated ? "pointer" : "not-allowed" } `} isLoading={loginLoading} onClick={handleLogin}  bg={"#f5d04c"} p={"5px"} w={"40%"} borderRadius={"10px"} color={"white"} > Login   </Button>
