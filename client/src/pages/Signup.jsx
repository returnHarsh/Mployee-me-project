            ...
            <div className="  rounded-[40px] relative flex-[55%] flex gap-5   flex-col  items-center  p-5 ounded-[40px]">
              ...
              <div className="flex  w-full  flex-col p-3 gap-4">
                ...
                <div className="relative flex flex-col w-full justify-center items-center">
                  <input value={signupDetails.password} onChange={(e) => handlePasswordChange(e)} className=" w-full px-3 py-3  bg-gray-50 outline-none focus:bg-white  rounded-md border shadow-md   border-gray-300 " type="password" placeholder="enter password" />
